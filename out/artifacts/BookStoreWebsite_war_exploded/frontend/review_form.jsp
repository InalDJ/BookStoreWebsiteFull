			...
			<table class="normal" width="60%">
				...
				<tr>
					...
					<td>
						 ...
						 <br/>
						<input type="text"  name="headline" size="60" placeholder="Headline or summary for your review" /> 
						<br/>
						<br/>
						<textarea  name="comment" cols="70" rows="10" placeholder="Write a review here..." /></textarea>
					</td>
				</tr>
