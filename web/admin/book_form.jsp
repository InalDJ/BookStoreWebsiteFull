	...
	<c:if test="${book == null}">
		...
		<table class="form">
			...
			<tr>
				...
				<td align="left"><input type="text" id="publishDate" name="publishDate" data-select="datepicker" size="20" value="${book.publishDate}" /></td>
			</tr>
...
$('#description').richText();
	...
	$("#bookForm").validate({
		...
		messages: {
			...
			bookImage: "Please attach an image of the book!",
